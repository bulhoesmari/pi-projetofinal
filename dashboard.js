...
function tabela_2(){
        ...
        ctx.removeAttribute("hidden");
        ctx.style.display = ("block");
        const labels = ['Matemática','Engenharia Civil','Cicência da computação','Sistemas para internet'];
        const data = {
            labels,
            datasets: [{
                data:[650,540,786,584,1000],
                borderWidth:1,
                borderColor: 'transparent',
                backgroundColor: 'rgba(77,166,253,0.85)',
                label: "Médias por curso da área"
            }]
        };
...
function tabela_3(){
        ...
        ctx.removeAttribute("hidden");
        ctx.style.display = ("block");
        const labels = ['Até um salário','De um à dois salários','De dois à três salários','Três ou mais salários'];
        const data = {
            labels,
            datasets: [{
